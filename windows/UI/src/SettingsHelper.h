...
/**
 * Check if the user would like to cancel the change from one-way to two-way
 *
 * @param int currentSyncType
 * @param int newSyncType
 *
 * @return bool True if the change should not be applied
 */
