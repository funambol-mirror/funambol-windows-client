...
void CCalendarSettings::loadSyncModesBox(const char* sourceName)
{
    ...
    int editBoxResourceID = IDC_CALENDAR_EDIT_SYNCTYPE;
    int comboBoxResourceID = IDC_CALENDAR_COMBO_SYNCTYPE;
