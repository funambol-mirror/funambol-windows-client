...
void CTaskSettings::loadSyncModesBox(const char* sourceName)
{
    ...
    int editBoxResourceID = IDC_TASKS_EDIT_SYNCTYPE;
    int comboBoxResourceID = IDC_TASKS_COMBO_SYNCTYPE;
