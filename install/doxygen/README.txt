...
/**
 * @mainpage The Funambol Outlook Plug-in Client.
 *
 * Welcome to the Funambol Outlook Plug-in Client! 
 * Bla bla bla...
 *
 ...
 *
 * To use the Doxygen config provided in the "doc" directory for the Funambol Outlook Plug-in,
 ...
 * - ENABLED_SECTIONS = "OLPLUGIN API" or "OLPLUGIN API DEV" to choose between user documentation and full documentation
