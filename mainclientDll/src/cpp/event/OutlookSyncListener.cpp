...
void OutlookSyncListener::syncEnd(SyncEvent &event) {
    LOG.info("END of Synchronization session.");
    SendMessage(HwndFunctions::getWindowHandle(), ID_MYMSG_SYNC_END, NULL, NULL);
}
