...
private:
    ...
    */
    ...
    /**
     * The date filtering for appointments source
     */
    DateFilter appointmentsDateFilter;

    /**
     * Sets CTCap for all PIM sources.
     */
    void readPIMSourcesCTCap();

    bool addSyncSourceConfig(const char* sourceName);
...
public:
    ...
    _declspec(dllexport) const ArrayList& getSourcesVisible();
    ...
    */
    ...
    /// Resets updater config to default, and saves to registry.
    _declspec(dllexport) void resetUpdaterConfig();
